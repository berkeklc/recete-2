...
class ProductAdminController extends Manager
{
    public $moduleTitle = 'Ürün İçerikleri';
    ...
    protected function insertAfterValidate()
    {
        $this->utils
            ...
            ->minSizes(222, 222)
            ->addProcessSize('normal', 348, 250, 'product', 'thumbnail');
    ...
    public function imageInsert()
    {
        ...
        $this->utils
            ...
            ->uploadInput('file')
            ->minSizes(100, 100)
            ->addProcessSize('thumb', 559, 361, 'product/thumb', 'thumbnail')
            ->addProcessSize('normal', 1024, 768, 'product/normal', 'fit-width');
    ...
    public function imageUpdate()
    {
        ...
        $parent = $this->appmodel->id($record->productId);
